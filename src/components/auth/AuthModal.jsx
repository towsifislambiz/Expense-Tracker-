...
import { Wallet, Mail, Lock, User, ArrowRight, AlertCircle, CheckCircle2, X, Eye, EyeOff } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-md max-h-[90vh] overflow-y-auto bg-[#141724] border border-white/10 rounded-2xl shadow-2xl z-10 p-5 sm:p-8 my-auto"
        >
          {onClose && (
            <button
              onClick={onClose}
